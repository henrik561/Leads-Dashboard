 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignAssetSetsRequest</code>
 */
class MutateCampaignAssetSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * sets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignAssetSetOperation[]  $operations  Required. The list of operations to perform on individual campaign asset
     *                                                                                      sets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign asset sets are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                   Required. The list of operations to perform on individual campaign asset
     *                                                                                                                   sets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignAssetSetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignAssetSetOperation::class);
        $this->operations = $arr;
