 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupAssetsRequest</code>
 */
class MutateAdGroupAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupAssetOperation[]  $operations  Required. The list of operations to perform on individual ad group assets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose ad group assets are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupAssetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                               Required. The list of operations to perform on individual ad group assets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupAssetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupAssetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupAssetOperation::class);
        $this->operations = $arr;
