 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupCustomizersRequest</code>
 */
class MutateAdGroupCustomizersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * customizers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupCustomizerOperation[]  $operations  Required. The list of operations to perform on individual ad group
     *                                                                                       customizers.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose ad group customizers are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                    Required. The list of operations to perform on individual ad group
     *                                                                                                                    customizers.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupCustomizerService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupCustomizerOperation::class);
        $this->operations = $arr;
