 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.GenerateAudienceCompositionInsightsRequest</code>
 */
class GenerateAudienceCompositionInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * compared.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.InsightsAudience baseline_audience = 6;</code>
     */
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\InsightsAudience  $audience  Required. The audience of interest for which insights are being requested.
     ...
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V17\Services\InsightsAudience $audience, array $dimensions): self
    {
        return (new self)
     ...
     *              Required. The ID of the customer.
     * @type \Google\Ads\GoogleAds\V17\Services\InsightsAudience $audience
     *                                                           Required. The audience of interest for which insights are being requested.
     * @type \Google\Ads\GoogleAds\V17\Services\InsightsAudience $baseline_audience
     *                                                           The baseline audience to which the audience of interest is being
     *                                                           compared.
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Services\InsightsAudience|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.InsightsAudience audience = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\InsightsAudience  $var
     * @return $this
     */
    public function setAudience($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Services\InsightsAudience::class);
        $this->audience = $var;
