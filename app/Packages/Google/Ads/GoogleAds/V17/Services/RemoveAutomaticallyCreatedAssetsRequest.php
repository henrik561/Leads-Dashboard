 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.RemoveAutomaticallyCreatedAssetsRequest</code>
 */
class RemoveAutomaticallyCreatedAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AssetsWithFieldType assets_with_field_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *                             automatically created assets.
     * @param  \Google\Ads\GoogleAds\V17\Services\AssetsWithFieldType[]  $assetsWithFieldType  Required. List of assets with field type to be removed from the AdGroupAd.
     *
     * @experimental
     */
     ...
     *              Required. The resource name of the AdGroupAd from which to remove
     *              automatically created assets.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AssetsWithFieldType>|\Google\Protobuf\Internal\RepeatedField $assets_with_field_type
     *                                                                                                             Required. List of assets with field type to be removed from the AdGroupAd.
     *                                                                                                             }
     */
    public function __construct($data = null)
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupAdService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AssetsWithFieldType assets_with_field_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AssetsWithFieldType>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setAssetsWithFieldType($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AssetsWithFieldType::class);
