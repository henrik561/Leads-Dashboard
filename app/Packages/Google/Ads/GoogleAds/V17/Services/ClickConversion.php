 ...
 * A click conversion.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.ClickConversion</code>
 */
class ClickConversion extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.ExternalAttributionData external_attribution_data = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomVariable custom_variables = 15;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.CartData cart_data = 16;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.UserIdentifier user_identifiers = 17;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.ConversionEnvironmentEnum.ConversionEnvironment conversion_environment = 20;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.Consent consent = 23;</code>
     */
     ...
     *              The order ID associated with the conversion. An order id can only be used
     *              for one conversion per conversion action.
     * @type \Google\Ads\GoogleAds\V17\Services\ExternalAttributionData $external_attribution_data
     *                                                                  Additional data about externally attributed conversions. This field
     *                                                                  is required for conversions with an externally attributed conversion
     *                                                                  action, but should not be set otherwise.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CustomVariable>|\Google\Protobuf\Internal\RepeatedField $custom_variables
     *                                                                                                        The custom variables associated with this conversion.
     * @type \Google\Ads\GoogleAds\V17\Services\CartData $cart_data
     *                                                   The cart data associated with this conversion.
     * @type array<\Google\Ads\GoogleAds\V17\Common\UserIdentifier>|\Google\Protobuf\Internal\RepeatedField $user_identifiers
     *                                                                                                      The user identifiers associated with this conversion. Only hashed_email and
     *                                                                                                      hashed_phone_number are supported for conversion uploads. The maximum
     *                                                                                                      number of user identifiers for each conversion is 5.
     * @type int $conversion_environment
     *           The environment this conversion was recorded on, for example, App or Web.
     * @type \Google\Ads\GoogleAds\V17\Common\Consent $consent
     *                                                The consent setting for the event.
     *                                                }
     */
    public function __construct($data = null)
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\ConversionUploadService::initOnce();
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.ExternalAttributionData external_attribution_data = 7;</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Services\ExternalAttributionData|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.ExternalAttributionData external_attribution_data = 7;</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\ExternalAttributionData  $var
     * @return $this
     */
    public function setExternalAttributionData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Services\ExternalAttributionData::class);
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomVariable custom_variables = 15;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CustomVariable>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setCustomVariables($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CustomVariable::class);
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.CartData cart_data = 16;</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Services\CartData|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.CartData cart_data = 16;</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\CartData  $var
     * @return $this
     */
    public function setCartData($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Services\CartData::class);
        $this->cart_data = $var;
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.UserIdentifier user_identifiers = 17;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Common\UserIdentifier>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setUserIdentifiers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Common\UserIdentifier::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\ConversionEnvironmentEnum\ConversionEnvironment::class);
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.Consent consent = 23;</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Common\Consent|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.Consent consent = 23;</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Common\Consent  $var
     * @return $this
     */
    public function setConsent($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Common\Consent::class);
        $this->consent = $var;
