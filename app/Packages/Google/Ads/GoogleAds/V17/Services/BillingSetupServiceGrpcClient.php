...
class BillingSetupServiceGrpcClient extends \Grpc\BaseStub
{
     ...
     *   [RequestError]()
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\MutateBillingSetupRequest  $argument  input argument
     * @param  array  $metadata  metadata
     * @param  array  $options  call options
     * @return \Grpc\UnaryCall
     */
    public function MutateBillingSetup(\Google\Ads\GoogleAds\V17\Services\MutateBillingSetupRequest $argument,
        $metadata = [], $options = [])
    {
        return $this->_simpleRequest('/google.ads.googleads.v17.services.BillingSetupService/MutateBillingSetup',
            $argument,
            ['\Google\Ads\GoogleAds\V17\Services\MutateBillingSetupResponse', 'decode'],
            $metadata, $options);
    }
}
