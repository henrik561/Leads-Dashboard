 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupBidModifiersRequest</code>
 */
class MutateAdGroupBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * modifiers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupBidModifierOperation[]  $operations  Required. The list of operations to perform on individual ad group bid
     *                                                                                        modifiers.
     *
     * @experimental
     */
     ...
     *              Required. ID of the customer whose ad group bid modifiers are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupBidModifierOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                     Required. The list of operations to perform on individual ad group bid
     *                                                                                                                     modifiers.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupBidModifierService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupBidModifierOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupBidModifierOperation::class);
        $this->operations = $arr;
