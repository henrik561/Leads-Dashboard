...
class AdGroupAdServiceGrpcClient extends \Grpc\BaseStub
{
     ...
     *   [UrlFieldError]()
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\MutateAdGroupAdsRequest  $argument  input argument
     * @param  array  $metadata  metadata
     * @param  array  $options  call options
     * @return \Grpc\UnaryCall
     */
    public function MutateAdGroupAds(\Google\Ads\GoogleAds\V17\Services\MutateAdGroupAdsRequest $argument,
        $metadata = [], $options = [])
    {
        return $this->_simpleRequest('/google.ads.googleads.v17.services.AdGroupAdService/MutateAdGroupAds',
            $argument,
            ['\Google\Ads\GoogleAds\V17\Services\MutateAdGroupAdsResponse', 'decode'],
            $metadata, $options);
    }
