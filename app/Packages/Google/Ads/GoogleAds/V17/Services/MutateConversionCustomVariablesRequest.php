 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateConversionCustomVariablesRequest</code>
 */
class MutateConversionCustomVariablesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * variables.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              being modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\ConversionCustomVariableOperation[]  $operations  Required. The list of operations to perform on individual conversion custom
     *                                                                                              variables.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose conversion custom variables are
     *              being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\ConversionCustomVariableOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                           Required. The list of operations to perform on individual conversion custom
     *                                                                                                                           variables.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\ConversionCustomVariableService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ConversionCustomVariableOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\ConversionCustomVariableOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\ConversionCustomVariableOperation::class);
        $this->operations = $arr;
