 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.UploadClickConversionsResponse</code>
 */
class UploadClickConversionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * true.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ClickConversionResult results = 2;</code>
     */
    private $results;
     ...
     *                          https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
     *                          for more information about partial failure.
     * @type array<\Google\Ads\GoogleAds\V17\Services\ClickConversionResult>|\Google\Protobuf\Internal\RepeatedField $results
     *                                                                                                               Returned for successfully processed conversions. Proto will be empty for
     *                                                                                                               rows that received an error. Results are not returned when validate_only is
     *                                                                                                               true.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ClickConversionResult results = 2;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\ClickConversionResult>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\ClickConversionResult::class);
        $this->results = $arr;
