 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAudiencesRequest</code>
 */
class MutateAudiencesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\AudienceOperation[]  $operations  Required. The list of operations to perform on individual audiences.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose audiences are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AudienceOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                           Required. The list of operations to perform on individual audiences.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AudienceOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AudienceOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AudienceOperation::class);
        $this->operations = $arr;
