 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateSharedSetsRequest</code>
 */
class MutateSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\SharedSetOperation[]  $operations  Required. The list of operations to perform on individual shared sets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose shared sets are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\SharedSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                            Required. The list of operations to perform on individual shared sets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\SharedSetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.SharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\SharedSetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\SharedSetOperation::class);
        $this->operations = $arr;
