 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateLabelsRequest</code>
 */
class MutateLabelsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\LabelOperation[]  $operations  Required. The list of operations to perform on labels.
     *
     * @experimental
     */
     ...
     *              Required. ID of the customer whose labels are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\LabelOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                        Required. The list of operations to perform on labels.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\LabelService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.LabelOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\LabelOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\LabelOperation::class);
        $this->operations = $arr;
