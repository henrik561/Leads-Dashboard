 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateSharedCriteriaRequest</code>
 */
class MutateSharedCriteriaRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.SharedCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\SharedCriterionOperation[]  $operations  Required. The list of operations to perform on individual shared criteria.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose shared criteria are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\SharedCriterionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                  Required. The list of operations to perform on individual shared criteria.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.SharedCriterionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\SharedCriterionOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\SharedCriterionOperation::class);
        $this->operations = $arr;
