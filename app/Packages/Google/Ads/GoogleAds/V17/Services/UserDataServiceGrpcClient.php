...
class UserDataServiceGrpcClient extends \Grpc\BaseStub
{
     ...
     *   [UserDataError]()
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\UploadUserDataRequest  $argument  input argument
     * @param  array  $metadata  metadata
     * @param  array  $options  call options
     * @return \Grpc\UnaryCall
     */
    public function UploadUserData(\Google\Ads\GoogleAds\V17\Services\UploadUserDataRequest $argument,
        $metadata = [], $options = [])
    {
        return $this->_simpleRequest('/google.ads.googleads.v17.services.UserDataService/UploadUserData',
            $argument,
            ['\Google\Ads\GoogleAds\V17\Services\UploadUserDataResponse', 'decode'],
            $metadata, $options);
    }
}
