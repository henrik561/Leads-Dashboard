 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignCustomizersRequest</code>
 */
class MutateCampaignCustomizersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * customizers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignCustomizerOperation[]  $operations  Required. The list of operations to perform on individual campaign
     *                                                                                        customizers.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign customizers are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                     Required. The list of operations to perform on individual campaign
     *                                                                                                                     customizers.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignCustomizerService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignCustomizerOperation::class);
        $this->operations = $arr;
