 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdsResponse</code>
 */
class MutateAdsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.MutateAdResult results = 2;</code>
     */
    private $results;
     ...
     *                          operations. If any errors occur outside the operations (for example, auth
     *                          errors), we return an RPC level error.
     * @type array<\Google\Ads\GoogleAds\V17\Services\MutateAdResult>|\Google\Protobuf\Internal\RepeatedField $results
     *                                                                                                        All results for the mutate.
     *                                                                                                        }
     */
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.MutateAdResult results = 2;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\MutateAdResult>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\MutateAdResult::class);
        $this->results = $arr;
