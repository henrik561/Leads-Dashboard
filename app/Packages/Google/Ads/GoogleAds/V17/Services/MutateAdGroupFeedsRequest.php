 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupFeedsRequest</code>
 */
class MutateAdGroupFeedsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupFeedOperation[]  $operations  Required. The list of operations to perform on individual ad group feeds.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose ad group feeds are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupFeedOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                              Required. The list of operations to perform on individual ad group feeds.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupFeedService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupFeedOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupFeedOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupFeedOperation::class);
        $this->operations = $arr;
