 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateExperimentArmsRequest</code>
 */
class MutateExperimentArmsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ExperimentArmOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\ExperimentArmOperation[]  $operations  Required. The list of operations to perform on individual experiment arm.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose experiments are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\ExperimentArmOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                Required. The list of operations to perform on individual experiment arm.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ExperimentArmOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\ExperimentArmOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\ExperimentArmOperation::class);
        $this->operations = $arr;
