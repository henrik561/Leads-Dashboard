 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignSharedSetsRequest</code>
 */
class MutateCampaignSharedSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * sets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignSharedSetOperation[]  $operations  Required. The list of operations to perform on individual campaign shared
     *                                                                                       sets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign shared sets are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignSharedSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                    Required. The list of operations to perform on individual campaign shared
     *                                                                                                                    sets.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignSharedSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignSharedSetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignSharedSetOperation::class);
        $this->operations = $arr;
