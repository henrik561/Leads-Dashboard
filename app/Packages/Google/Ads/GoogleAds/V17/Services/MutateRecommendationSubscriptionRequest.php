 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateRecommendationSubscriptionRequest</code>
 */
class MutateRecommendationSubscriptionRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.RecommendationSubscriptionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\RecommendationSubscriptionOperation[]  $operations  Required. The list of create or update operations.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the subscribing customer.
     * @type array<\Google\Ads\GoogleAds\V17\Services\RecommendationSubscriptionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                             Required. The list of create or update operations.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\RecommendationSubscriptionService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.RecommendationSubscriptionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\RecommendationSubscriptionOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\RecommendationSubscriptionOperation::class);
        $this->operations = $arr;
