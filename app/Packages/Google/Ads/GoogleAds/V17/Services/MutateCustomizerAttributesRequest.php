 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCustomizerAttributesRequest</code>
 */
class MutateCustomizerAttributesRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * attributes.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomizerAttributeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CustomizerAttributeOperation[]  $operations  Required. The list of operations to perform on individual customizer
     *                                                                                         attributes.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose customizer attributes are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CustomizerAttributeOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                      Required. The list of operations to perform on individual customizer
     *                                                                                                                      attributes.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CustomizerAttributeService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomizerAttributeOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CustomizerAttributeOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CustomizerAttributeOperation::class);
        $this->operations = $arr;
