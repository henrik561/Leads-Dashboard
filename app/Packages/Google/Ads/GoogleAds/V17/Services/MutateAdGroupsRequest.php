 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupsRequest</code>
 */
class MutateAdGroupsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupOperation[]  $operations  Required. The list of operations to perform on individual ad groups.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose ad groups are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                          Required. The list of operations to perform on individual ad groups.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupOperation::class);
        $this->operations = $arr;
