 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.GenerateAudienceOverlapInsightsRequest</code>
 */
class GenerateAudienceOverlapInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * audiences.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.LocationInfo country_location = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.AudienceInsightsAttribute primary_attribute = 3 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $dimensions;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Common\LocationInfo  $countryLocation  Required. The country in which to calculate the sizes and overlaps of
     *                                                                          audiences.
     * @param  \Google\Ads\GoogleAds\V17\Services\AudienceInsightsAttribute  $primaryAttribute  Required. The audience attribute that should be intersected with all other
     *                                                                                          eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *                                                                                          AgeRange or a Gender.
     * @param  int[]  $dimensions  Required. The types of attributes of which to calculate the overlap with
     *                             the primary_attribute. The values must be a subset of
     *                             AFFINITY_USER_INTEREST, IN_MARKET_USER_INTEREST, AGE_RANGE and GENDER.
     *                             For allowed values, use constants defined on {@see \Google\Ads\GoogleAds\V17\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension}
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V17\Common\LocationInfo $countryLocation, \Google\Ads\GoogleAds\V17\Services\AudienceInsightsAttribute $primaryAttribute, array $dimensions): self
    {
        return (new self)
     ...
     *              Required. The ID of the customer.
     * @type \Google\Ads\GoogleAds\V17\Common\LocationInfo $country_location
     *                                                     Required. The country in which to calculate the sizes and overlaps of
     *                                                     audiences.
     * @type \Google\Ads\GoogleAds\V17\Services\AudienceInsightsAttribute $primary_attribute
     *                                                                    Required. The audience attribute that should be intersected with all other
     *                                                                    eligible audiences.  This must be an Affinity or In-Market UserInterest, an
     *                                                                    AgeRange or a Gender.
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Ads\GoogleAds\V17\Enums\AudienceInsightsDimensionEnum\AudienceInsightsDimension::class);
        $this->dimensions = $arr;
