 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignAssetsRequest</code>
 */
class MutateCampaignAssetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignAssetOperation[]  $operations  Required. The list of operations to perform on individual campaign assets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign assets are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignAssetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                Required. The list of operations to perform on individual campaign assets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignAssetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignAssetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignAssetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignAssetOperation::class);
        $this->operations = $arr;
