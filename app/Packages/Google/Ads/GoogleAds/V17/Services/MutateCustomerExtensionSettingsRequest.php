 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCustomerExtensionSettingsRequest</code>
 */
class MutateCustomerExtensionSettingsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * extension settings.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              being modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CustomerExtensionSettingOperation[]  $operations  Required. The list of operations to perform on individual customer
     *                                                                                              extension settings.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose customer extension settings are
     *              being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CustomerExtensionSettingOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                           Required. The list of operations to perform on individual customer
     *                                                                                                                           extension settings.
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomerExtensionSettingOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CustomerExtensionSettingOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CustomerExtensionSettingOperation::class);
        $this->operations = $arr;
