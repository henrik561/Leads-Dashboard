 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateConversionActionsRequest</code>
 */
class MutateConversionActionsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * actions.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\ConversionActionOperation[]  $operations  Required. The list of operations to perform on individual conversion
     *                                                                                      actions.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose conversion actions are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\ConversionActionOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                   Required. The list of operations to perform on individual conversion
     *                                                                                                                   actions.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\ConversionActionService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ConversionActionOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\ConversionActionOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\ConversionActionOperation::class);
        $this->operations = $arr;
