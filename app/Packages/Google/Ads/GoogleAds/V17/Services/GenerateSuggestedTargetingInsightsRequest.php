 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.GenerateSuggestedTargetingInsightsRequest</code>
 */
class GenerateSuggestedTargetingInsightsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.InsightsAudience baseline_audience = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
     */
     ...
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V17\Services\InsightsAudience $audience): self
    {
        return (new self)
