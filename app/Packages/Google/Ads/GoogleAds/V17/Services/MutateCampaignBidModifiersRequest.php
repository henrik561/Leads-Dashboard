 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignBidModifiersRequest</code>
 */
class MutateCampaignBidModifiersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * modifiers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignBidModifierOperation[]  $operations  Required. The list of operations to perform on individual campaign bid
     *                                                                                         modifiers.
     *
     * @experimental
     */
     ...
     *              Required. ID of the customer whose campaign bid modifiers are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignBidModifierOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                      Required. The list of operations to perform on individual campaign bid
     *                                                                                                                      modifiers.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignBidModifierService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignBidModifierOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignBidModifierOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignBidModifierOperation::class);
        $this->operations = $arr;
