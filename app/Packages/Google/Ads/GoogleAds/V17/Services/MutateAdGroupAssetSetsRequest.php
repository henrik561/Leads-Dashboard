 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAdGroupAssetSetsRequest</code>
 */
class MutateAdGroupAssetSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * sets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\AdGroupAssetSetOperation[]  $operations  Required. The list of operations to perform on individual ad group asset
     *                                                                                     sets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose ad group asset sets are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AdGroupAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                  Required. The list of operations to perform on individual ad group asset
     *                                                                                                                  sets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AdGroupAssetSetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AdGroupAssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AdGroupAssetSetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AdGroupAssetSetOperation::class);
        $this->operations = $arr;
