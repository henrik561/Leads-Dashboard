 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.AudienceCompositionAttributeCluster</code>
 */
class AudienceCompositionAttributeCluster extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.AudienceCompositionMetrics cluster_metrics = 3;</code>
     */
     ...
     * metrics.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AudienceCompositionAttribute attributes = 4;</code>
     */
    private $attributes;
     ...
     *              The name of this cluster of attributes
     * @type \Google\Ads\GoogleAds\V17\Services\AudienceCompositionMetrics $cluster_metrics
     *                                                                     If the dimension associated with this cluster is YOUTUBE_CHANNEL, then
     *                                                                     cluster_metrics are metrics associated with the cluster as a whole.
     *                                                                     For other dimensions, this field is unset.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AudienceCompositionAttribute>|\Google\Protobuf\Internal\RepeatedField $attributes
     *                                                                                                                      The individual attributes that make up this cluster, with metadata and
     *                                                                                                                      metrics.
     *                                                                                                                      }
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.AudienceCompositionMetrics cluster_metrics = 3;</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Services\AudienceCompositionMetrics|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.services.AudienceCompositionMetrics cluster_metrics = 3;</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Services\AudienceCompositionMetrics  $var
     * @return $this
     */
    public function setClusterMetrics($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Services\AudienceCompositionMetrics::class);
