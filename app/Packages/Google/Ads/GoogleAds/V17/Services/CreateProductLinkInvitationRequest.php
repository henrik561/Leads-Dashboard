 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.CreateProductLinkInvitationRequest</code>
 */
class CreateProductLinkInvitationRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.resources.ProductLinkInvitation product_link_invitation = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    protected $product_link_invitation = null;

    /**
     * @param  string  $customerId  Required. The ID of the customer being modified.
     * @param  \Google\Ads\GoogleAds\V17\Resources\ProductLinkInvitation  $productLinkInvitation  Required. The product link invitation to be created.
     *
     * @experimental
     */
    public static function build(string $customerId, \Google\Ads\GoogleAds\V17\Resources\ProductLinkInvitation $productLinkInvitation): self
    {
        return (new self)
