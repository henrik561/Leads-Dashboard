 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.TargetFrequencySettings</code>
 */
class TargetFrequencySettings extends \Google\Protobuf\Internal\Message
{
     ...
     * target_frequency.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit time_unit = 1 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\TargetFrequencyTimeUnitEnum\TargetFrequencyTimeUnit::class);
        $this->time_unit = $var;
