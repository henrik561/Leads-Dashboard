 ...
 * https://github.com/googleapis/googleapis/blob/master/google/ads/googleads/v17/services/feed_mapping_service.proto
...
use Google\Ads\GoogleAds\V17\Services\MutateFeedMappingsRequest;
use Google\Ads\GoogleAds\V17\Services\MutateFeedMappingsResponse;
 ...
 *
 * @method PromiseInterface mutateFeedMappingsAsync(MutateFeedMappingsRequest $request, array $optionalArgs = [])
 */
class FeedMappingServiceClient
{
    ...
    private const SERVICE_NAME = 'google.ads.googleads.v17.services.FeedMappingService';
