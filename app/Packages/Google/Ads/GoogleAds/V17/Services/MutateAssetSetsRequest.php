 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateAssetSetsRequest</code>
 */
class MutateAssetSetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\AssetSetOperation[]  $operations  Required. The list of operations to perform on individual asset sets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose asset sets are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\AssetSetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                           Required. The list of operations to perform on individual asset sets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\AssetSetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.AssetSetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\AssetSetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\AssetSetOperation::class);
        $this->operations = $arr;
