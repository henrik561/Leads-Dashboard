 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignBudgetsRequest</code>
 */
class MutateCampaignBudgetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignBudgetOperation[]  $operations  Required. The list of operations to perform on individual campaign budgets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign budgets are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignBudgetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                 Required. The list of operations to perform on individual campaign budgets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignBudgetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignBudgetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignBudgetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignBudgetOperation::class);
        $this->operations = $arr;
