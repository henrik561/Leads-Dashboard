 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCustomerCustomizersRequest</code>
 */
class MutateCustomerCustomizersRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * customizers.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomerCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\CustomerCustomizerOperation[]  $operations  Required. The list of operations to perform on individual customer
     *                                                                                        customizers.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose customer customizers are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CustomerCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                     Required. The list of operations to perform on individual customer
     *                                                                                                                     customizers.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CustomerCustomizerService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CustomerCustomizerOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CustomerCustomizerOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CustomerCustomizerOperation::class);
        $this->operations = $arr;
