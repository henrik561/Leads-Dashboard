 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateCampaignDraftsRequest</code>
 */
class MutateCampaignDraftsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     * @param  \Google\Ads\GoogleAds\V17\Services\CampaignDraftOperation[]  $operations  Required. The list of operations to perform on individual campaign drafts.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose campaign drafts are being modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\CampaignDraftOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                Required. The list of operations to perform on individual campaign drafts.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\CampaignDraftService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.CampaignDraftOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\CampaignDraftOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\CampaignDraftOperation::class);
        $this->operations = $arr;
