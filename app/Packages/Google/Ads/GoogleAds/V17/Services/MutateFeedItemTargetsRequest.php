 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateFeedItemTargetsRequest</code>
 */
class MutateFeedItemTargetsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * targets.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\FeedItemTargetOperation[]  $operations  Required. The list of operations to perform on individual feed item
     *                                                                                    targets.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose feed item targets are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\FeedItemTargetOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                 Required. The list of operations to perform on individual feed item
     *                                                                                                                 targets.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\FeedItemTargetService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.FeedItemTargetOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\FeedItemTargetOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\FeedItemTargetOperation::class);
        $this->operations = $arr;
