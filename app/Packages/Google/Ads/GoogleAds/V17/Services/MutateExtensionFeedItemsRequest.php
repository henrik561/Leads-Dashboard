 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.services.MutateExtensionFeedItemsRequest</code>
 */
class MutateExtensionFeedItemsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     * items.
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    private $operations;
     ...
     *                              modified.
     * @param  \Google\Ads\GoogleAds\V17\Services\ExtensionFeedItemOperation[]  $operations  Required. The list of operations to perform on individual extension feed
     *                                                                                       items.
     *
     * @experimental
     */
     ...
     *              Required. The ID of the customer whose extension feed items are being
     *              modified.
     * @type array<\Google\Ads\GoogleAds\V17\Services\ExtensionFeedItemOperation>|\Google\Protobuf\Internal\RepeatedField $operations
     *                                                                                                                    Required. The list of operations to perform on individual extension feed
     *                                                                                                                    items.
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Services\ExtensionFeedItemService::initOnce();
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.services.ExtensionFeedItemOperation operations = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Services\ExtensionFeedItemOperation>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setOperations($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Services\ExtensionFeedItemOperation::class);
        $this->operations = $arr;
