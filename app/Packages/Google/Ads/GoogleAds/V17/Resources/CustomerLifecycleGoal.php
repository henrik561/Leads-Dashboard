 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CustomerLifecycleGoal</code>
 */
class CustomerLifecycleGoal extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.LifecycleGoalValueSettings customer_acquisition_goal_value_settings = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *              Customer lifecycle resource names have the form:
     *              `customers/{customer_id}/customerLifecycleGoal`
     * @type \Google\Ads\GoogleAds\V17\Common\LifecycleGoalValueSettings $customer_acquisition_goal_value_settings
     *                                                                   Output only. Customer acquisition goal customer level value settings.
     *                                                                   }
     */
    public function __construct($data = null)
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CustomerLifecycleGoal::initOnce();
