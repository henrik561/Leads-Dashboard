 ...
 * extensions.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CallView</code>
 */
class CallView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation call_tracking_display_location = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.CallTypeEnum.CallType type = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $type = 0;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus call_status = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CallView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\CallTrackingDisplayLocationEnum\CallTrackingDisplayLocation::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\CallTypeEnum\CallType::class);
        $this->type = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\GoogleVoiceCallStatusEnum\GoogleVoiceCallStatus::class);
