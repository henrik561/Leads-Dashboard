 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.HotelReconciliation</code>
 */
class HotelReconciliation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus status = 10 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\HotelReconciliation::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\HotelReconciliationStatusEnum\HotelReconciliationStatus::class);
        $this->status = $var;
