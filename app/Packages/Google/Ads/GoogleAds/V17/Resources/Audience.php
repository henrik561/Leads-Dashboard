 ...
 * segments.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.Audience</code>
 */
class Audience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.AudienceStatusEnum.AudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.AudienceDimension dimensions = 6;</code>
     */
    private $dimensions;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.AudienceScopeEnum.AudienceScope scope = 8;</code>
     */
    protected $scope = 0;
     ...
     *              Description of this audience.
     * @type array<\Google\Ads\GoogleAds\V17\Common\AudienceDimension>|\Google\Protobuf\Internal\RepeatedField $dimensions
     *                                                                                                         Positive dimensions specifying the audience composition.
     * @type \Google\Ads\GoogleAds\V17\Common\AudienceExclusionDimension $exclusion_dimension
     *                                                                   Negative dimension specifying the audience composition.
     * @type int $scope
     *           Defines the scope this audience can be used in. By default, the scope is
     *           CUSTOMER. Audiences can be created with a scope of ASSET_GROUP for
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\Audience::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\AudienceStatusEnum\AudienceStatus::class);
        $this->status = $var;
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.AudienceDimension dimensions = 6;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Common\AudienceDimension>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setDimensions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Common\AudienceDimension::class);
        $this->dimensions = $arr;
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     *
     * @return \Google\Ads\GoogleAds\V17\Common\AudienceExclusionDimension|null
     */
     ...
     * Generated from protobuf field <code>.google.ads.googleads.v17.common.AudienceExclusionDimension exclusion_dimension = 7;</code>
     *
     * @param  \Google\Ads\GoogleAds\V17\Common\AudienceExclusionDimension  $var
     * @return $this
     */
    public function setExclusionDimension($var)
    {
        GPBUtil::checkMessage($var, \Google\Ads\GoogleAds\V17\Common\AudienceExclusionDimension::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\AudienceScopeEnum\AudienceScope::class);
        $this->scope = $var;
