 ...
 * level.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.SearchTermView</code>
 */
class SearchTermView extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\SearchTermView::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\SearchTermTargetingStatusEnum\SearchTermTargetingStatus::class);
        $this->status = $var;
