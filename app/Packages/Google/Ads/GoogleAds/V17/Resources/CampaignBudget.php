 ...
 * A campaign budget.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CampaignBudget</code>
 */
class CampaignBudget extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.BudgetStatusEnum.BudgetStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod delivery_method = 7;</code>
     */
     ...
     * specified.
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.BudgetPeriodEnum.BudgetPeriod period = 13 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $period = 0;
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.BudgetTypeEnum.BudgetType type = 18 [(.google.api.field_behavior) = IMMUTABLE];</code>
     */
    protected $type = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CampaignBudget::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BudgetStatusEnum\BudgetStatus::class);
        $this->status = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BudgetDeliveryMethodEnum\BudgetDeliveryMethod::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BudgetPeriodEnum\BudgetPeriod::class);
        $this->period = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BudgetTypeEnum\BudgetType::class);
        $this->type = $var;
