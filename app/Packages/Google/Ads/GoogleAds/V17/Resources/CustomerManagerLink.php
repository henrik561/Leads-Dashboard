 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CustomerManagerLink</code>
 */
class CustomerManagerLink extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.ManagerLinkStatusEnum.ManagerLinkStatus status = 5;</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CustomerManagerLink::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\ManagerLinkStatusEnum\ManagerLinkStatus::class);
        $this->status = $var;
