 ...
 * audiences.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CombinedAudience</code>
 */
class CombinedAudience extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.CombinedAudienceStatusEnum.CombinedAudienceStatus status = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CombinedAudience::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\CombinedAudienceStatusEnum\CombinedAudienceStatus::class);
        $this->status = $var;
