 ...
 * A campaign draft.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CampaignDraft</code>
 */
class CampaignDraft extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.CampaignDraftStatusEnum.CampaignDraftStatus status = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CampaignDraft::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\CampaignDraftStatusEnum\CampaignDraftStatus::class);
        $this->status = $var;
