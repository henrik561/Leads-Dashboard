 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.AssetSetAsset</code>
 */
class AssetSetAsset extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\AssetSetAsset::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\AssetSetAssetStatusEnum\AssetSetAssetStatus::class);
        $this->status = $var;
