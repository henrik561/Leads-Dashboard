 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.resources.CampaignAssetSet</code>
 */
class CampaignAssetSet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.AssetSetLinkStatusEnum.AssetSetLinkStatus status = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    protected $status = 0;
    ...
    {
        \GPBMetadata\Google\Ads\GoogleAds\V17\Resources\CampaignAssetSet::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\AssetSetLinkStatusEnum\AssetSetLinkStatus::class);
        $this->status = $var;
