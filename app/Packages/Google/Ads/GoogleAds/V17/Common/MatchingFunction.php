 ...
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.common.MatchingFunction</code>
 */
class MatchingFunction extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.ads.googleads.v17.enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator operator = 4;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.Operand left_operands = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.Operand right_operands = 3;</code>
     */
     ...
     * @type int $operator
     *           Operator for a function.
     * @type array<\Google\Ads\GoogleAds\V17\Common\Operand>|\Google\Protobuf\Internal\RepeatedField $left_operands
     *                                                                                               The operands on the left hand side of the equation. This is also the
     *                                                                                               operand to be used for single operand expressions such as NOT.
     * @type array<\Google\Ads\GoogleAds\V17\Common\Operand>|\Google\Protobuf\Internal\RepeatedField $right_operands
     *                                                                                               The operands on the right hand side of the equation.
     *                                                                                               }
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\MatchingFunctionOperatorEnum\MatchingFunctionOperator::class);
        $this->operator = $var;
     ...
     * Generated from protobuf field <code>repeated .google.ads.googleads.v17.common.Operand left_operands = 2;</code>
     *
     * @param  array<\Google\Ads\GoogleAds\V17\Common\Operand>|\Google\Protobuf\Internal\RepeatedField  $var
     * @return $this
     */
    public function setLeftOperands($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Ads\GoogleAds\V17\Common\Operand::class);
