 ...
 * graph.
 *
 * Generated from protobuf message <code>google.ads.googleads.v17.common.BrandInfo</code>
 */
class BrandInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v17.enums.BrandRequestRejectionReasonEnum.BrandRequestRejectionReason rejection_reason = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
     ...
     *
     * Generated from protobuf field <code>optional .google.ads.googleads.v17.enums.BrandStateEnum.BrandState status = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BrandRequestRejectionReasonEnum\BrandRequestRejectionReason::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Ads\GoogleAds\V17\Enums\BrandStateEnum\BrandState::class);
        $this->status = $var;
