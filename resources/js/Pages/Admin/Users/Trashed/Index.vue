...
import TrashedUser from '@/Components/Users/TrashedUser.vue';
...
const getNotTrashedUserCount = computed(() => {
    return props.notTrashedUserCount.toLocaleString('en-US', {
        notation: 'compact',
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Gebruikers archief ({{
                            getTrashedUsersCount }})</h1>
                    ...
                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex gap-2 flex-row">
                        <Link
                            ...
                            :href="route('admin.users.index')">Terug naar overzicht ({{ getNotTrashedUserCount }})
                        </Link>
                    </div>
                </div>
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead>
                                    <tr>
                                        <th scope="col"
                                            class="py-3 relative isolate pl-4 pr-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500 sm:pl-0">
                                            Name
                                        </th>
                                        <th scope="col"
                                ...
                                <tbody v-if="users.length" class="divide-y divide-gray-200 bg-white">
                                    <TrashedUser v-for="user in users" :key="user.id" :user="user"></TrashedUser>
                                </tbody>
                            </table>
